...
public class VentanaSwing extends JFrame{
    ...
    public VentanaSwing() throws HeadlessException {
        setTitle("Conversion de grados centigrados a grados farengeith");
        setSize(400, 300);
        ...
        boton.setToolTipText("Click para convertir en Grados Farenheit");
        resultado = new JLabel("Farengeith");
        lista = new JComboBox();
